...
import { Shield, Eye, EyeOff, CheckCircle, AlertCircle, ArrowLeft, Clock, Scissors, Star } from 'lucide-react';
      ...
      <div className="relative z-10 px-12 xl:px-20 max-w-xl text-center">
        ...
        <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-6">
          ...
          <p className="text-gray-300 text-sm italic leading-relaxed">
            "Tu seguridad es lo primero. Restablece tu contraseña de forma rápida y segura."
          </p>
          <p className="text-[#d8b081] text-xs font-semibold mt-3 uppercase tracking-wider">
            Proceso de recuperación verificado
          </p>
        </div>
      </div>
      ...
      return rightPanelContainer(
        <div className="text-center">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-6 relative overflow-hidden bg-[#d8b081]/10 border border-[#d8b081]/20">
            <div className="w-6 h-6 border-2 border-[#d8b081] border-t-transparent rounded-full animate-spin" />
          </div>
          ...
          <div className="pt-2">
            <Button
              ...
              className={`login-btn w-full h-12 rounded-xl font-bold text-sm uppercase tracking-wider transition-all duration-300 ${
                !isLoading && passwords.newPassword && passwords.newPassword === passwords.confirmPassword && passwordValidations.minLength
