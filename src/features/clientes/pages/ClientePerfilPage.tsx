    ...
    <div>
      ...
      <div className="mb-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Foto y perfil */}
          <div className="lg:col-span-1 flex flex-col items-center text-center gap-6 rounded-xl p-6 bg-gray-darkest border border-gray-dark">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <div className="p-4 rounded-xl bg-gray-darkest border border-gray-dark">
